export const dataWithCommits = {
  search: {
    edges: [
      ...
      {
        node: {
          avatarUrl: 'https://avatars1.githubusercontent.com/u/36778150?v=4',
          login: 'miahuynh',
          commitComments: {
            nodes: [],
          },
      ...
      {
        node: {
          avatarUrl: 'https://avatars0.githubusercontent.com/u/29414935?v=4',
          login: 'miahawkins',
          commitComments: {
            nodes: [],
          },
